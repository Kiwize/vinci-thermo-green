...
public class LoginView extends JFrame {
	...
	public LoginView(Controller controller) {
		...
		Label lblUsername = new Label(controller.getResourceBundle().getString("loginViewUsername"));
		lblUsername.setBounds(70, 59, 104, 17);
		getContentPane().add(lblUsername);

		Label lblPassword = new Label(controller.getResourceBundle().getString("loginViewPassword"));
		...
		ButtonRound btnSubmit = new ButtonRound(controller.getResourceBundle().getString("loginViewSubmit"), this.getWidth() / 2, 160);
		...
		Button visiblePasswordBtn = new Button("", 384, 98);
		...
		ButtonRound btnChangePassword = new ButtonRound("Modifier le mot de passe", this.getWidth() / 4 - 105 / 2, 160);
